...
import com.ddp.lrs.actors.QueueConnector.SendMessageResultContainer
import com.ddp.lrs.actors.{QueueConnector, StockPriceConnector}
import com.ddp.lrs.models.errors.ExternalResourceNotFoundException
import com.ddp.lrs.models.marshalling.CustomMarshallers._
import com.ddp.lrs.models.{DailyQuoteResult, GetQuoteModel, QueueMessage}

import scala.concurrent.duration._
import scala.concurrent.{ExecutionContextExecutor, Future}

class HighwayRoutes(queueConnector: ActorRef, stockPriceConnector: ActorRef)
